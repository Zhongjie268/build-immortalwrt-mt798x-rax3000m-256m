...
#修改wifi名称（mtwifi-cfg）
sed -i 's/ImmortalWrt-2.4G/666999' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ImmortalWrt-5G/6669999' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
